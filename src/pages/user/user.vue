      ...
      activeCodeVisible = false
		...
		<scroll-view scroll-y>
          ...
          ">
                  ...
                  : '永久VIP会员'
                    ...
                    activeCodeVisible = true
						...
						<van-cell title-class="user-fontsize-cell" title="邀请好友" is-link center>
							<view style="display: flex; justify-content: flex-end">
								<van-button open-type="share" custom-style="width: 134rpx;" round size="small"
									type="primary">
									邀请
								</van-button>
							</view>
						...
						<van-cell v-if="vipPackage.childVisible == 1" title-class="user-fontsize-cell" title="分销中心"
							is-link center url="/otherPages/sellerCenter/index">
						</van-cell>
					</van-cell-group>
				</view>
            ...
            box-shadow: 0rpx 0rpx 12rpx 2rpx rgba(0, 0, 0, 0.1);
          ">
					<van-cell title-class="user-fontsize-cell" title="激活码入口" is-link center
        ...
        >
          ...
          >
						...
						<van-cell title-class="user-fontsize-cell" title="用户反馈" is-link center
          ...
          <m-icon type="fkbz" class="cell-icon" />
            ...
            " color="#a8a8a8" size="18" name="cross" />
              ...
              <image mode="widthFix" style="width: 100rpx;" :src="userInfo.headImage||'https://mmbiz.qpic.cn/mmbiz/icTdbqWNOwNRna42FI242Lcia07jQodd2FJGIYQfG0LAJGFxM4FbnQP6yfMxBgJ0F3YRqJCJ1aPAK2dQagdusBZg/0'"></image>
						...
						<van-field value-class="userform-visible" :value="userInfo.nickName" required clearable
							label="用户头像" use-button-slot placeholder="请输入用户名">
							<image slot="input" class="userform-head" :src="userInfo.headImage"></image>
							<view style="height: 100rpx" slot="button">
								<button size="mini" open-type="chooseAvatar" @chooseavatar="getUserHeadImage"
									type="primary">
									上传头像
								</button>
							</view>
						...
						<van-field :value="userInfo.phone" clearable label="手机号" placeholder="请绑定手机号"
					...
					<view class="userform-bind">
						<van-button @click="sendUserInfo" custom-style="width:690rpx;" round
							type="primary">修改用户信息</van-button>
					</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				orderId: '',
				gzhWebPath: process.env.NODE_ENV === "development" ?
		...
		methods: {
			...
			goGzhPage() {
				let storageWebSrc =
					"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx2e7a22bed898f795&redirect_uri=https://nbjk-h5.zzxcx.net/qcxjWxUserInfo&response_type=code&scope=snsapi_userinfo&state=LOGIN#wechat_redirect";
